...
extern const MIDL_SERVER_INFO intouch_ServerInfo;

extern const RPC_DISPATCH_TABLE intouch_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE intouch___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x4e0c90df,0xe39d,0x4164,{0xa4,0x21,0xac,0xe8,0x94,0x84,0xc6,0x02}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&intouch_v1_0_DispatchTable,
    0,
    0,
    0,
    &intouch_ServerInfo,
...
RPC_IF_HANDLE intouch_v1_0_s_ifspec = (RPC_IF_HANDLE)& intouch___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
namespace {
    ...
    const unsigned char g_My_RpcClientInterface1[68] = {
    0x44, 0x00, 0x00, 0x00,
    ...
    const static RPC_BINDING_HANDLE intouch__MIDL_AutoBindHandle1;

    const unsigned char g_My_pFormatTypes1[50] = {
    ...
    static const MIDL_STUB_DESC intouch_StubDesc =
    {
        //(void *)& intouch___RpcClientInterface,
        g_My_RpcClientInterface1,       // [0] RpcInterfaceInformation
        MIDL_user_allocate,
        MIDL_user_free,
        &intouch__MIDL_AutoBindHandle1,  // [3] FormatStringOffset (NDR ¸ñÊ½×Ö·û´®)
        ...
        g_My_pFormatTypes1,    // [8] pFormatTypes
...
static const MIDL_STUB_DESC intouch_StubDesc_old = 
    {
    (void *)& intouch___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION intouch_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE intouch_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)intouch_table
    };

static const SERVER_ROUTINE intouch_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)IntouchFunction0,
    (SERVER_ROUTINE)IntouchFunction1,
    (SERVER_ROUTINE)IntouchFunction2,
    (SERVER_ROUTINE)IntouchFunction3
    };

static const MIDL_SERVER_INFO intouch_ServerInfo = 
    {
    &intouch_StubDesc,
    intouch_ServerRoutineTable,
    intouch__MIDL_ProcFormatString.Format,
    intouch_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
